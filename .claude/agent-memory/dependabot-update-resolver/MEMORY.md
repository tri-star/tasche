...
- [worktree未初期化時のbackend docker検証](backend_env_not_initialized_blocks_docker_verification.md) — .env無し(コピーもしない)ならcompose.yamlのデフォルト値で検証成功することがある(PR #116)。プレースホルダ入り.envは逆にNG
