...
export const getGetCurrentGoalsApiWeeksCurrentGoalsGetResponseMock = (overrideResponse: Partial< APIResponseGoalsResponse > = {}): APIResponseGoalsResponse => ({data: {week_id: faker.string.alpha({length: {min: 10, max: 20}}), week_start_date: faker.string.alpha({length: {min: 10, max: 20}}), unit_duration_minutes: faker.number.int({min: undefined, max: undefined}), daily_available_units: {monday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), tuesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), wednesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), thursday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), friday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), saturday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), sunday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined])}, goals: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({task_id: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), daily_targets: {monday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), tuesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), wednesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), thursday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), friday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), saturday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), sunday: faker.number.float({min: 0, max: undefined, fractionDigits: 2})}})), has_current_goals: faker.datatype.boolean(), previous_goals: faker.helpers.arrayElement([faker.helpers.arrayElement([{week_id: faker.string.alpha({length: {min: 10, max: 20}}), week_start_date: faker.string.alpha({length: {min: 10, max: 20}}), unit_duration_minutes: faker.number.int({min: undefined, max: undefined}), daily_available_units: {monday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), tuesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), wednesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), thursday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), friday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), saturday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), sunday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined])}, goals: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({task_id: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), daily_targets: {monday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), tuesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), wednesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), thursday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), friday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), saturday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), sunday: faker.number.float({min: 0, max: undefined, fractionDigits: 2})}}))},null,]), undefined])}, ...overrideResponse})

export const getUpdateCurrentGoalsApiWeeksCurrentGoalsPutResponseMock = (overrideResponse: Partial< APIResponseGoalsUpdateResponse > = {}): APIResponseGoalsUpdateResponse => ({data: {week_id: faker.string.alpha({length: {min: 10, max: 20}}), week_start_date: faker.string.alpha({length: {min: 10, max: 20}}), unit_duration_minutes: faker.number.int({min: undefined, max: undefined}), daily_available_units: {monday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), tuesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), wednesday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), thursday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), friday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), saturday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined]), sunday: faker.helpers.arrayElement([faker.number.float({min: 0, max: undefined, fractionDigits: 2}), undefined])}, goals: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({task_id: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), daily_targets: {monday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), tuesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), wednesday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), thursday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), friday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), saturday: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), sunday: faker.number.float({min: 0, max: undefined, fractionDigits: 2})}})), created_tasks: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha({length: {min: 10, max: 20}}), name: faker.string.alpha({length: {min: 10, max: 20}})}))}, ...overrideResponse})
...
export const getUpsertRecordApiWeeksCurrentRecordsDayOfWeekTaskIdPutResponseMock = (overrideResponse: Partial< APIResponseRecordResponse > = {}): APIResponseRecordResponse => ({data: {id: faker.string.alpha({length: {min: 10, max: 20}}), week_id: faker.string.alpha({length: {min: 10, max: 20}}), task_id: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), day_of_week: faker.helpers.arrayElement(Object.values(DayOfWeek)), actual_units: faker.number.float({min: 0, max: undefined, fractionDigits: 2}), created_at: `${faker.date.past().toISOString().split('.')[0]}Z`, updated_at: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})
...
export const getUpsertRecordApiWeeksCurrentRecordsDayOfWeekTaskIdPutMockHandler = (overrideResponse?: APIResponseRecordResponse | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<APIResponseRecordResponse> | APIResponseRecordResponse), options?: RequestHandlerOptions) => {
  return http.put('*/api/weeks/current/records/:dayOfWeek/:taskId', async (info) => {await delay(0);
